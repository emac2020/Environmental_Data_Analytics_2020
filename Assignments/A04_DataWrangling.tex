...
\NormalTok{O3NC2018 <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_O3_NC2018_raw.csv"}\NormalTok{)}
\NormalTok{O3NC2019 <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_O3_NC2019_raw.csv"}\NormalTok{)}
\NormalTok{PM25NC2018 <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_PM25_NC2018_raw.csv"}\NormalTok{)}
\NormalTok{PM25NC2019 <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_PM25_NC2019_raw.csv"}\NormalTok{)}

\CommentTok{#2a: O3_NC2018 dimensions, column names, structure}

\KeywordTok{dim}\NormalTok{(O3NC2018)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#2b: O3_NC2019 dimensions, column names, structure}

\KeywordTok{dim}\NormalTok{(O3NC2019)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#2c: PM25_NC2018 dimensions, column names, structure}

\KeywordTok{dim}\NormalTok{(PM25NC2018)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#2d: PM25_NC2019 dimensions, column names, structure}
\KeywordTok{dim}\NormalTok{(PM25NC2019)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{class}\NormalTok{(O3NC2018}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{O3NC2018}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(O3NC2018}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%Y"}\NormalTok{)}

\KeywordTok{class}\NormalTok{(O3NC2019}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{O3NC2019}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(O3NC2019}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%Y"}\NormalTok{)}

\KeywordTok{class}\NormalTok{(PM25NC2018}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{PM25NC2018}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(PM25NC2018}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%Y"}\NormalTok{)}

\KeywordTok{class}\NormalTok{(PM25NC2019}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{PM25NC2019}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(PM25NC2019}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%Y"}\NormalTok{)}

\CommentTok{#4}
\CommentTok{#Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE}

\NormalTok{O3NC2018.Select <-}\StringTok{ }
\StringTok{  }\NormalTok{O3NC2018 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY}\OperatorTok{:}\NormalTok{SITE_LONGITUDE)}

\NormalTok{O3NC2019.Select <-}
\StringTok{  }\NormalTok{O3NC2019 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY}\OperatorTok{:}\NormalTok{SITE_LONGITUDE)}

\NormalTok{PM25NC2018.Select <-}
\StringTok{  }\NormalTok{PM25NC2018 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY}\OperatorTok{:}\NormalTok{SITE_LONGITUDE)}

\NormalTok{PM25NC2019.Select <-}
\StringTok{  }\NormalTok{PM25NC2019 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY}\OperatorTok{:}\NormalTok{SITE_LONGITUDE)}

\CommentTok{#5}

\NormalTok{PM25NC2018.}\FloatTok{2.5}\NormalTok{ <-}\StringTok{ }\KeywordTok{mutate}\NormalTok{(PM25NC2018.Select, }\DataTypeTok{AQS_PARAMETER_DESC =} \StringTok{"PM2.5"}\NormalTok{)}
\KeywordTok{view}\NormalTok{(PM25NC2018.}\FloatTok{2.5}\NormalTok{)}

\NormalTok{PM25NC2019.}\FloatTok{2.5}\NormalTok{ <-}\StringTok{ }\KeywordTok{mutate}\NormalTok{(PM25NC2019.Select, }\DataTypeTok{AQS_PARAMETER_DESC =} \StringTok{"PM2.5"}\NormalTok{)}
\KeywordTok{view}\NormalTok{(PM25NC2019.}\FloatTok{2.5}\NormalTok{)}
...
\KeywordTok{write.csv}\NormalTok{(O3NC2018.Select, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
...
\NormalTok{EPA.Data.Summary.DF <-}\StringTok{ }
\StringTok{  }\NormalTok{EPAair.Datasets.Summaries.Spread }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{meanOzone =} \KeywordTok{mean}\NormalTok{(Ozone),}
            \DataTypeTok{meanPM2.5 =} \KeywordTok{mean}\NormalTok{(PM2.}\DecValTok{5}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{drop_na}\NormalTok{(month, year)}


\CommentTok{#13}

\KeywordTok{dim}\NormalTok{(EPA.Data.Summary.DF)}
\end{Highlighting}
\end{Shaded}
