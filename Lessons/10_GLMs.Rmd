...
Ozone.Density.plot <- ggplot(EPAair, aes(x = Ozone, color = as.factor(Year))) +
  geom_density(fill = "gray", alpha = 0.5) +  
  geom_vline(xintercept = 50, color = "#238b45", lty = 2, size = 0.9) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0))
print(Ozone.Density.plot)

# Geom_boxplot

Ozone.boxplot <- ggplot(EPAair, aes(x = Ozone, y = as.factor(Year), color = "Year")) +
  geom_boxplot() +
  stat_summary(letters = "Year") +
